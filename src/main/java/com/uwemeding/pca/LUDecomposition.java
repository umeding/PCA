...
public class LUDecomposition implements java.io.Serializable {
	...
	/**
	 * Get the pivot permutation vector as a one-dimensional double array
	 * @return     (double) piv
	 */
	 ...
	 * Determinant
	 * @return     det(A)
	 * @exception  MathException  Matrix must be square
	 */
	public double det() {
		if (m != n) {
			throw new MathException("Matrix must be square.");
		}
	 ...
	 * @exception  MathException  Matrix is singular.
	 */
